...
describe("Route to list all", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    jest
      .spyOn(BuscarTodosUsuariosUsecase.prototype, "execute")
  ...
  test("Should return error 500 if there is an exception", async () => {
    jest
      .spyOn(BuscarTodosUsuariosUsecase.prototype, "execute")
      .mockImplementation(() => {
    ...
    expect(result.body).toHaveProperty("mensagem");
  });
});
